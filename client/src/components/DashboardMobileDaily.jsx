...
export default function DashboardMobileDaily({
    ...
    return (
        <div className="flex flex-col gap-12 pb-32 pt-20 px-4">

            {/* ── Header ── */}
            <div>
                <p className="text-[10px] tracking-widest uppercase opacity-40 mb-3">Operational Finance</p>
                <h2 className="text-3xl font-light tracking-wide uppercase mb-2">Daily Finances</h2>
                <p className="text-sm opacity-60 tracking-wide">Real-time cashflow and active goals.</p>
            </div>
