...
export default function DashboardMobileWealth({ forecastData, formData, spendingClusters, monthlySpent, monthlyIncome, insights }) {
    ...
    return (
        <div className="flex flex-col gap-12 pb-32 pt-20 px-6">

            {/* ── Net Worth Forecast ── */}
            <div className="space-y-6">
                <div>
                    <p className="text-[10px] tracking-widest uppercase opacity-40 mb-3">Net Worth Forecast</p>
            ...
            <div className="space-y-6">
                <p className="text-[10px] tracking-widest uppercase opacity-40">This Month Breakdown</p>
            ...
            <div className="space-y-4">
                <p className="text-[10px] tracking-widest uppercase opacity-40">AI Insights</p>
            ...
            <div className="space-y-6">
                <p className="text-[10px] tracking-widest uppercase opacity-40">Spending Architecture</p>
                <div className="space-y-4">
