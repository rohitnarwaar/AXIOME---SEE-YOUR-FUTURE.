...
// In Next.js, this should point to a file in the /public folder
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <motion.nav
        ...
        className="relative z-20 flex justify-between items-center py-6 font-mono"
        style={{
          paddingLeft: '10%',
          paddingRight: '10%'
        }}
      >
        ...
        <div className="flex gap-8 text-sm tracking-wide">
          <button onClick={() => router.push('/')} className="hover:opacity-70 transition-opacity">Home</button>
          <button onClick={() => router.push('/dashboard')} className="hover:opacity-70 transition-opacity">Dashboard</button>
        </div>
      </motion.nav>
      ...
      <motion.div
        ...
        transition={{ duration: 0.8 }}
        className="px-[10%] py-12 font-mono"
      >
        {/* Header */}
