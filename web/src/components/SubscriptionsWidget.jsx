...
export default function SubscriptionsWidget({
    ...
    const SubCard = ({ sub, isPaused = false }) => {
        ...
        return (
            ...
            >
                <ServiceAvatar key={sub.name} name={sub.name} />
                        ...
                        <AnimatePresence>
                            {activeMenu === sub.id && (
                                <motion.div
                                    ...
                                    className="absolute right-0 top-8 z-20 bg-white border border-black/10 shadow-lg min-w-[140px] py-1 font-mono"
                                >
                                    <button
                    ...
                    >
                        <div className="border border-black/10 bg-black/[0.015] p-6 mb-6 space-y-4">
                            <div className="flex items-center gap-4 mb-2">
                                <ServiceAvatar key={formName} name={formName} size="w-12 h-12" />
                                <div>
